...
var Celsiustemp:number = 70;
var C_tO_F : number = (Celsiustemp * 9/5) + 32;
console.log("celcius to fahrehiet temperature is:", C_tO_F);

var fahrenheit:number = 70;
...
var week:number=7;
var day_to_week:number= given_days/week;
